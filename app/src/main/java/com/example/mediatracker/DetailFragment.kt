...
class DetailFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        if (args != null) {
            ...
            // Gérer le cas où les arguments ne sont pas disponibles ou l'ID du média est manquant
            // Vous pouvez afficher un message d'erreur ou retourner à l'écran précédent
            // ou prendre une autre action appropriée
            return null
        }
